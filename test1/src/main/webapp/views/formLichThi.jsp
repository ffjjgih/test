...
<head>
    ...
    <link rel="stylesheet" href="./views/assets/lichThi.css">
        ...
        <div class="modal_download js-modal_download">
            <div class="modal_download-container js-modal_download-container">
                <div class="header-modal_dowload-container">
                    <img class="btn_close" src="./views/assets/image/left-arrow.png" alt="">
                </div>
                <div class="body-modal_dowload-container">
                    <img src="./views/assets/image/241400644_4384520114929340_1276692022253364513_n.png" alt="">
                </div>
